...
public class AlgaeSubsystem extends SubsystemBase {
  ...
  private final AprilTagAlignSubsystem aprilTagAlign = new AprilTagAlignSubsystem();
  ...
  public void periodic() {
      ...
      if (X_BUTTON && IS_X_TOGGLED == False) {
        IS_X_TOGGLED = True;
      ...
      if (X_BUTTON) {
          if (IS_X_TOGGLED = False) {
            liftspeed = 0.0;
          } else if (IS_X_TOGGLED = True){
            liftspeed = 0.2;
          }
      }
