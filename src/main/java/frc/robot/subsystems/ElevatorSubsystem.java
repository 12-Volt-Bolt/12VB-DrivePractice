...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private static final double TOLERANCE = 0.5; // Added tolerance constant
    ...
    public void periodic() {
        ...
        // Preset level selection remains the same
        if (rightBumper) {
        ...
        // Simple position check instead of proportional control
