...
//import frc.robot.subsystems.IntakeSubsystem;
  ...
  public class Robot extends TimedRobot {
    ...
    public void robotInit() {
      ...
      autonChooser.addOption("Noah Triangle, its very silly lololololololololololololololololololololol, with an italian spice", new FullAutoTest());
    ...
    public void robotPeriodic() {
      ...
      if (!BunnyBoardran) {
        BunnyBoard.sendData("Pitch", String.valueOf(m_driveSubsystem.getPitch()));
        BunnyBoard.sendData("Yaw", String.valueOf(m_driveSubsystem.getYaw()));
        BunnyBoard.sendData("Roll", String.valueOf(m_driveSubsystem.getRoll()));
        BunnyBoard.sendData("Angle", String.valueOf(m_driveSubsystem.getGyroAngle()));


        if (m_driveSubsystem.getPitch() == 0){
          BunnyBoard.sendData("Gyro", "Inactive");
        } else {
          BunnyBoard.sendData("Gyro", "Running");
        }
      }
