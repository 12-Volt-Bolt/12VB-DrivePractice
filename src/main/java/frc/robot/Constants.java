...
public final class Constants {
    ...
    public static final double ELEVATOR_GEAR_RATIO = 10.0; // This is 10:1 ratio
    public static final double ELEVATOR_SPOOL_DIAMETER = 1.5; // Inches
    public static final double ELEVATOR_MAX_HEIGHT = 50.0; // Inches
    public static final double ELEVATOR_MIN_HEIGHT = 2.0; // Inches
